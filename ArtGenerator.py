...
#build adam optimizers. paper said to use .0002. discriminator a tad stronb so used .0001
...
with tf.Session(config=config) as sess:
    ...
    for epoch in range(numEpochs):
        for numBatch, (realData) in enumerate(dataLoader):
            ...
            realData = realData.numpy() #turns them into numpy and sticks them into another array
